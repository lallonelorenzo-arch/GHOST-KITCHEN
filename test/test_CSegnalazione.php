...
print_r(CSegnalazione::avviaSegnalazione(10, 'recensione', 3001));

echo "\nUC11 - invia segnalazione\n";
print_r(CSegnalazione::inviaSegnalazione([
    'idSegnalante' => 10,
...
print_r(CSegnalazione::avviaSegnalazione(10, 'recensione', 9999));

echo "\nUC11 - input non valido\n";
try {
    CSegnalazione::avviaSegnalazione(10, 'ordine', 1);
