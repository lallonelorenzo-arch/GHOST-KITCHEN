...
<section class="section ops-flow">
    ...
    <div class="ops-grid">
        <section class="ops-panel">
            ...
            <?php if ($slots === []): ?><p class="muted-text">Nessun calendario chef disponibile per il ruolo corrente.</p><?php endif; ?>
            <div class="ops-list">
        ...
        <section class="ops-panel">
            ...
            <?php if ($slots === []): ?><p class="muted-text"><?= $ghostKitchenGestore === [] ? 'Nessun calendario ghost kitchen disponibile per il ruolo corrente.' : 'Seleziona una ghost kitchen per visualizzare il calendario.' ?></p><?php endif; ?>
            <div class="ops-list">
                <?php foreach ($slots as $slot): ?>
                    <div class="ops-list-item"><strong><?= V::e($slot->getData()) ?></strong><span><?= V::e($slot->getOraInizio()) ?> - <?= V::e($slot->getOraFine()) ?></span><span class="badge"><?= V::e($slot->getStato()) ?></span></div>
                <?php endforeach; ?>
