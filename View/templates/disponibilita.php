    ...
    <div class="ops-grid">
        <?php if ($isChef): ?>
            <section class="ops-panel">
                ...
                $calendarEmptyText = 'Nessuna disponibilita chef pubblicata.';
        ...
        <?php if ($isGestore): ?>
            <section class="ops-panel">
                ...
                <?php
                $calendarSlots = $slots;
                $calendarTitle = 'Calendario ghost kitchen';
                $calendarEmptyText = $ghostKitchenGestore === [] ? 'Nessuna ghost kitchen collegata al tuo profilo.' : 'Seleziona una ghost kitchen per visualizzare il calendario.';
                $calendarSelectable = false;
                include __DIR__ . '/partials/booking_calendar.php';
                ?>
            </section>
