...
<section class="page-hero compact-hero uc-page-hero">
    ...
    <p>Verifica documento, chef collegato e note amministrative.</p>
</section>
    ...
    <?php if ($certificazione !== null): ?>
        <div class="uc-grid">
            <article class="uc-panel">
                ...
                <?php endif; ?>
                <?php if ($chef !== null): ?>
                    <p class="uc-muted">Chef: <?= V::e($chef->getNome() . ' ' . $chef->getCognome()) ?></p>
                <?php endif; ?>
            </article>

            <article class="uc-panel">
                <h2>Decisione</h2>
                <form class="uc-form" method="post" action="<?= V::e(V::url('/certificazioni/' . $certificazione->getIdCertificazione() . '/approva')) ?>">
                    <label>Note admin
                ...
                <form class="uc-form" method="post" action="<?= V::e(V::url('/certificazioni/' . $certificazione->getIdCertificazione() . '/rifiuta')) ?>">
