...
<section class="section chef-dashboard">
    <nav class="chef-dashboard-tabs" aria-label="Sezioni dashboard chef">
        <?php foreach ($tabs as $key => $label): ?>
            <a class="<?= $tabAttiva === $key ? 'is-active' : '' ?>" href="<?= V::e(V::url('/dashboard', ['tab' => $key])) ?>">
                <?= V::e($label) ?>
    ...
    <section class="chef-dashboard-panel upcoming-panel">
        <header>
            ...
            <a href="<?= V::e(V::url('/dashboard', ['tab' => 'prenotazioni'])) ?>">Vedi tutte &rarr;</a>
        </header>
                ...
                <table class="booking-table">
                    ...
                    <?php foreach ($prenotazioniTabella as $item): ?>
                        ...
                        <tr>
                            ...
                            <td><a class="table-detail-link" href="<?= V::e(V::url('/dashboard', ['tab' => 'prenotazioni', 'id' => (int) $prenotazione->getIdPrenotazione()])) ?>">Dettagli</a></td>
                        </tr>
                    <?php endforeach; ?>
                    </tbody>
                </table>
            ...
            <header class="requests-header">
                ...
                <nav class="requests-tabs" aria-label="Filtro richieste">
                    <?php foreach ($requestFilters as $key => $label): ?>
                        <a class="<?= $filtroRichieste === $key ? 'is-active' : '' ?>" href="<?= V::e(V::url('/dashboard', ['tab' => 'richieste', 'filtro' => $key])) ?>"><?= V::e($label) ?></a>
                    <?php endforeach; ?>
                </nav>
            </header>
